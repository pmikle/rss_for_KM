...
(function(e) {
    ...
    e.extend(n.prototype, {
        ...
        _updateDatepicker: function(t) {
			close_btn = "<div id='close_date'>x</div><div class='clear'></div>"; 
            this.maxRows = 4,
            v = t,
            t.dpDiv.empty().append(close_btn).append(this._generateHTML(t)),
        ...
        _generateHTML: function(e) {
            ...
            l = B ? "ui-datepicker-buttonpane ui-widget-content'>" + (Y ? h : "") + (this._isInRange(e, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") + (Y ? "" : h) + "</div>" : "",
